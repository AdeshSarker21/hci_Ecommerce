<x-admin.layout title="Create Product" active="products">
    <x-admin.page-header title="Create Product">
        <x-slot:subtitle>Add a new product to the marketplace</x-slot:subtitle>
        <x-slot:actions>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="4"
                                      class="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-colors duration-200">{{ old('description') }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">Description (Bangla)</label>
                            <textarea name="description_bn" rows="4"
                                      class="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-colors duration-200">{{ old('description_bn') }}</textarea>
                        </div>
                    </div>
                </x-admin.card>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4" x-show="previews.length > 0">
                            <template x-for="(preview, index) in previews" :key="index">
                                <div class="relative group rounded-lg overflow-hidden border-2"
                                     :class="featuredIndex === index ? 'border-indigo-500' : 'border-gray-200'">
                                    ...
                                    <div class="absolute top-1 right-1 opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
                                        <button type="button" x-on:click="featuredIndex = index"
                                                ...
                                                :class="featuredIndex === index ? 'bg-indigo-500 text-white' : 'bg-white/80 text-gray-700'">
                                        ...
                                        <button type="button" x-on:click="removeNewImage(index)"
                                                class="p-1 rounded-full bg-white/80 text-red-500">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="meta_description" rows="3"
                                      class="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-colors duration-200">{{ old('meta_description') }}</textarea>
                        </div>
                    </div>
                </x-admin.card>
            </div>
