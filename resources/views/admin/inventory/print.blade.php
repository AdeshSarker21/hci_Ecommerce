...
<body>
    <div class="no-print" style="margin-bottom: 20px;">
        <button onclick="window.print()" style="padding: 8px 16px; background: #4f46e5; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 14px;">Print Labels</button>
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 16px;">
        ...
        <div class="label">
            ...
            @endif
            <div class="barcode">
                <img src="{{ route('admin.inventory.barcode-svg', $product) }}" alt="Barcode">
            </div>
            @if($product->price)
        ...
        <div class="label">
            ...
            <p class="sku">{{ $product->sku }}</p>
            <div class="qr">
                <img src="{{ route('admin.inventory.qr-svg', $product) }}" alt="QR Code">
            </div>
