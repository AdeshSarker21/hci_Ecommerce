<x-admin.layout title="Edit Warehouse - {{ $warehouse->name }}" active="warehouses">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="address" rows="2"
                                      class="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-colors duration-200">{{ old('address', $warehouse->address) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="seller_id"
                                ...
                                @foreach($sellers as $seller)
                                    <option value="{{ $seller->id }}" {{ old('seller_id', $warehouse->seller_id) == $seller->id ? 'selected' : '' }}>
                                        {{ $seller->store_name }}
                                    </option>
                                @endforeach
                            </select>
