                ...
                <x-admin.card title="Brand Information">
                    <div class="space-y-5">
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $brand->name) }}" required placeholder="Enter brand name"
                        ...
                        <div>
                            ...
                            <input type="text" name="name_bn" id="name_bn" value="{{ old('name_bn', $brand->name_bn) }}" placeholder="বাংলায় ব্র্যান্ডের নাম"
                                   class="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-colors duration-200">
                        </div>
                        <div>
                            <label for="description" class="block text-sm font-medium text-gray-700 mb-1.5">Description</label>
                            <textarea name="description" id="description" rows="3" placeholder="Brief description of this brand"
                                      class="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-colors duration-200 resize-none">{{ old('description', $brand->description) }}</textarea>
                        </div>
                        <div>
                ...
                <x-admin.card title="Logo & Settings">
                    <div class="space-y-5">
                        <div>
                            ...
                            <input type="url" name="logo" id="logo" value="{{ old('logo', $brand->logo) }}" placeholder="https://example.com/logo.png"
                                   class="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-colors duration-200">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $brand->sort_order) }}" min="0" placeholder="0"
                                   class="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-colors duration-200">
                        </div>
                    </div>
                </x-admin.card>
