                    ...
                    <div class="space-y-5">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="e.g. Color, Size, Material"
                            ...
                            <div>
                                ...
                                <input type="text" name="name_bn" id="name_bn" value="{{ old('name_bn') }}" placeholder="বাংলায় নাম"
                                       class="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-colors duration-200">
                            </div>
                        </div>
                        <div>
                ...
                <x-admin.card title="Attribute Values">
                    ...
                    <div id="values-container" class="space-y-3">
                        <div class="flex items-center gap-3 value-row">
                            <input type="text" name="values[0][value]" placeholder="Value (English)" class="flex-1 rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-colors duration-200">
                            <input type="text" name="values[0][value_bn]" placeholder="Value (Bangla)" class="flex-1 rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-colors duration-200">
                            <input type="text" name="values[0][color_code]" placeholder="#hex" class="w-24 rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-colors duration-200">
