                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="name_bn" id="name_bn" value="{{ old('name_bn', $attribute->name_bn) }}"
                                       class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                            </div>
                        </div>
                        <div>
                    ...
                    <div id="values-container" class="space-y-3">
                        @foreach($attribute->values as $index => $value)
                            <div class="flex items-center gap-3 value-row">
                                ...
                                <input type="text" name="values[{{ $index }}][value]" value="{{ $value->value }}" placeholder="Value (English)" class="flex-1 rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                                <input type="text" name="values[{{ $index }}][value_bn]" value="{{ $value->value_bn }}" placeholder="Value (Bangla)" class="flex-1 rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                                <input type="text" name="values[{{ $index }}][color_code]" value="{{ $value->color_code }}" placeholder="#hex" class="w-24 rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                ...
                <x-admin.card title="Settings">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $attribute->sort_order) }}" min="0"
                                   class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                        </div>
                    </div>
                </x-admin.card>
