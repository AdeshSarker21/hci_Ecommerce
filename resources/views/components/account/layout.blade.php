        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 py-6 lg:py-10">
            ...
            <div class="lg:hidden flex items-center justify-between mb-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-[14px] font-bold text-gray-900">{{ $user->name }}</p>
                ...
                <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
                    ...
                    <div class="h-full overflow-y-auto p-4">
                        ...
                        <div class="grid grid-cols-2 gap-2 mb-6">
                            <a href="{{ route('account.orders') }}" class="p-3 bg-white border border-gray-100 rounded-xl hover:border-emerald-200 hover:bg-emerald-50 transition-all text-center group">
                                <p class="text-[18px] font-bold text-gray-900 group-hover:text-emerald-600 transition-colors">{{ $pendingOrders }}</p>
                                <p class="text-[10px] text-gray-400 font-medium">{{ __('Pending Orders') }}</p>
                            </a>
                            <a href="{{ route('account.wishlist') }}" class="p-3 bg-white border border-gray-100 rounded-xl hover:border-emerald-200 hover:bg-emerald-50 transition-all text-center group">
                                <p class="text-[18px] font-bold text-gray-900 group-hover:text-emerald-600 transition-colors">{{ $wishlistCount }}</p>
                        ...
                        <nav class="space-y-0.5">
                            ...
                            <div class="pt-3 pb-1 px-3">
                                <p class="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">{{ __('Shopping') }}</p>
                            </div>
                            ...
                            <a href="{{ route('account.orders') }}"
                               class="nav-item {{ $isActive('account.orders') }}">
                                ...
                                {{ __('My Orders') }}
                                @if($pendingOrders > 0)
                                    <span class="ml-auto px-1.5 py-0.5 text-[10px] font-bold bg-amber-100 text-amber-700 rounded-full">{{ $pendingOrders }}</span>
                                @endif
                            </a>
                            ...
                            <a href="{{ route('account.wishlist') }}"
                               class="nav-item {{ $isActive('account.wishlist') }}">
                                ...
                                {{ __('Wishlist') }}
                                @if($wishlistCount > 0)
                                    <span class="ml-auto px-1.5 py-0.5 text-[10px] font-bold bg-pink-100 text-pink-700 rounded-full">{{ $wishlistCount }}</span>
                                @endif
                            </a>
                            ...
                            <div class="pt-3 pb-1 px-3">
                                <p class="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">{{ __('Account') }}</p>
                            </div>
                            ...
                            <div class="pt-3 pb-1 px-3">
                                <p class="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">{{ __('Settings') }}</p>
                            </div>
                        ...
                        <div class="mt-6 pt-4 border-t border-gray-100">
                            <p class="text-[10px] font-semibold text-gray-400 uppercase tracking-wider px-3 mb-3">{{ __('Quick Links') }}</p>
                            <div class="space-y-1">
                                <a href="{{ route('cart.index') }}" class="flex items-center gap-2 px-3 py-2 text-[12px] text-gray-500 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg transition-colors">
                                    ...
                                    {{ __('Shopping Cart') }}
                                    @if($cartCount > 0)
                                        <span class="ml-auto px-1.5 py-0.5 text-[10px] font-bold bg-emerald-100 text-emerald-700 rounded-full">{{ $cartCount }}</span>
                                    @endif
                                </a>
                                <a href="{{ route('search') }}" class="flex items-center gap-2 px-3 py-2 text-[12px] text-gray-500 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg transition-colors">
                                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
