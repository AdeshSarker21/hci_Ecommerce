                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description_bn" id="description_bn" rows="4"
                                      class="w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm">{{ old('description_bn') }}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="meta_description" id="meta_description" rows="3"
                                      class="w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm">{{ old('meta_description') }}</textarea>
                        </div>
                    </div>
                </div>
