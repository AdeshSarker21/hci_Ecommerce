<x-seller.layout title="Edit Product" active="products">
    ...
    <form method="POST" action="{{ route('seller.products.update', $product) }}" x-data="productSpecs()" x-init="init()">
        @csrf
        @method('PUT')
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="meta_description" id="meta_description" rows="3"
                                      class="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-colors duration-200">{{ old('meta_description', $product->meta_description) }}</textarea>
                        </div>
                    </div>
                </div>
